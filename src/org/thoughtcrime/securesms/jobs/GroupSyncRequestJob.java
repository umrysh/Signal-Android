...
public class GroupSyncRequestJob extends MasterSecretJob implements InjectableType {
    @Inject transient SignalCommunicationModule.SignalMessageSenderFactory messageSenderFactory;
